...
namespace STVRogue.GameLogic
{
	public class XTest_Game
	{
		...
		public void CheckIfMonsterBalancingHolds()
		{
			...
			int nodeCapacityMultiplier = 5;
			int numberOfMonsters = 50;
			int monstersInDungeon = 0;
			int maxMonstersOnThisLevel, amountOfMonstersOnThisLevel;
			Game game = new Game(difficultyLevel, nodeCapacityMultiplier, numberOfMonsters);

			for (int i = 0; i < game.dungeon.bridges.Length-1; i++)
			{
